          ...
          <div>
            ...
            <div class="mt-2 flex space-x-2">
              <div class="avatar size-8">
                <img class="mask is-squircle" src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="avatar">
              </div>
              <div class="avatar size-8">
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:grid-cols-2 sm:gap-5 lg:mt-6 lg:grid-cols-4 lg:gap-6">
          ...
          <div class="card">
            ...
            <div class="ax-transparent-gridline">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogVisitors); $el._x_chart.render() });"></div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="ax-transparent-gridline">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogMembers); $el._x_chart.render() });"></div>
            </div>
          </div>
        </div>
          ...
          <div class="mt-3 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="mt-4 hidden pl-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-3 lg:flex">
              <div class="flex items-center justify-center px-3">
                <img class="w-full" src="{{ asset('assets/images/illustrations/writer.svg') }}" alt="image">
              </div>
            </div>
            <div class="is-scrollbar-hidden col-span-12 flex space-x-4 overflow-x-auto px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-9 lg:pl-0">
              <div class="card w-64 shrink-0 pb-3">
                <div class="h-20 rounded-t-lg bg-primary dark:bg-accent">
                  <img class="h-full w-full rounded-t-lg object-cover object-center" src="{{ asset('assets/images/object/object-2.jpg') }}" alt="image">
                </div>
                <div class="px-4 py-2 sm:px-5">
                  <div class="flex justify-between space-x-4">
                    <div class="avatar -mt-12 size-20">
                      <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{ asset('assets/images/avatar/avatar-4.jpg') }}" alt="avatar">
                    </div>
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors1); $el._x_chart.render() });"></div>
                    </div>
              ...
              <div class="card w-64 shrink-0 pb-3">
                <div class="h-20 rounded-t-lg bg-primary dark:bg-accent">
                  <img class="h-full w-full rounded-t-lg object-cover object-center" src="{{ asset('assets/images/object/object-13.jpg') }}" alt="image">
                </div>
                <div class="px-4 py-2 sm:px-5">
                  <div class="flex justify-between space-x-4">
                    <div class="avatar -mt-12 size-20">
                      <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{ asset('assets/images/avatar/avatar-19.jpg') }}" alt="avatar">
                    </div>
                    <div class="flex space-x-2">
                      <button class="btn size-7 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                        <i class="fab fa-twitter"></i>
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors2); $el._x_chart.render() });"></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                        168
                  ...
                  <div class="mt-2 flex justify-between">
                    <div class="flex -space-x-2">
                      ...
                      <div class="avatar size-7 hover:z-10">
                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-17.jpg') }}" alt="avatar">
                      </div>
                    </div>
                    <button class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                      <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              ...
              <div class="card w-64 shrink-0 pb-3">
                <div class="h-20 rounded-t-lg bg-primary dark:bg-accent">
                  <img class="h-full w-full rounded-t-lg object-cover object-center" src="{{ asset('assets/images/object/object-17.jpg') }}" alt="image">
                </div>
                <div class="px-4 py-2 sm:px-5">
                  <div class="flex justify-between space-x-4">
                    <div class="avatar -mt-12 size-20">
                      <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{ asset('assets/images/avatar/avatar-18.jpg') }}" alt="avatar">
                    </div>
                    <div class="flex space-x-2">
                      <button class="btn size-7 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                        <i class="fab fa-twitter"></i>
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors3); $el._x_chart.render() });"></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                        426
                  ...
                  <div class="mt-2 flex justify-between">
                    <div class="flex -space-x-2">
                      <div class="avatar size-7 hover:z-10">
                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="avatar">
                      </div>
                      ...
                      <div class="avatar size-7 hover:z-10">
                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="avatar">
                      </div>
                    </div>
                    <button class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                      <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              ...
              <div class="card w-64 shrink-0 pb-3">
                <div class="h-20 rounded-t-lg bg-primary dark:bg-accent">
                  <img class="h-full w-full rounded-t-lg object-cover object-center" src="{{ asset('assets/images/object/object-16.jpg') }}" alt="image">
                </div>
                <div class="px-4 py-2 sm:px-5">
                  <div class="flex justify-between space-x-4">
                    <div class="avatar -mt-12 size-20">
                      <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{ asset('assets/images/avatar/avatar-12.jpg') }}" alt="avatar">
                    </div>
                    <div class="flex space-x-2">
                      <button class="btn size-7 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                        <i class="fab fa-twitter"></i>
                  ...
                  <div class="mt-1 flex items-center space-x-4">
                    <div class="w-9/12">
                      <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.blogAuthors4); $el._x_chart.render() });"></div>
                    </div>
                    <div class="w-3/12 text-center">
                      <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                        98
                  ...
                  <div class="mt-2 flex justify-between">
                    <div class="flex -space-x-2">
                      <div class="avatar size-7 hover:z-10">
                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="avatar">
                      </div>

                      <div class="avatar size-7 hover:z-10">
                        <div class="is-initial rounded-full bg-secondary text-xs+ uppercase text-white ring ring-white dark:ring-navy-700">
                          re
                        </div>
                      </div>

                      <div class="avatar size-7 hover:z-10">
                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="avatar">
                      </div>
                    </div>
                    <button class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                      <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              ...
              <div class="card w-64 shrink-0 pb-3">
                <div class="h-20 rounded-t-lg bg-primary dark:bg-accent">
                  <img class="h-full w-full rounded-t-lg object-cover object-center" src="{{ asset('assets/images/object/object-14.jpg') }}" alt="image">
                </div>
                <div class="px-4 py-2 sm:px-5">
                  <div class="flex justify-between space-x-4">
                    <div class="avatar -mt-12 size-20">
                      <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="avatar">
                    </div>
                    <div class="flex space-x-2">
                      <button class="btn size-7 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                        <i class="fab fa-twitter"></i>
        ...
        <div class="mt-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 lg:mt-6">
          ...
          <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-2.jpg') }}" alt="image">
                ...
                <div class="mt-4 flex items-center justify-between">
                  <a href="#" class="flex items-center space-x-2 text-xs hover:text-slate-800 dark:hover:text-navy-100">
                    <div class="avatar size-6">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="avatar">
                    </div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-3.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-4.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-5.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-9.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
                  <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">How Did We Get Here?</a>
                </div>
                <p class="mt-2 grow line-clamp-3">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                </p>
                <div class="mt-4 flex items-center justify-between">
                  <a href="#" class="flex items-center space-x-2 text-xs hover:text-slate-800 dark:hover:text-navy-100">
                    <div class="avatar size-6">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-11.jpg') }}" alt="avatar">
                    </div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-8.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
                  <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">NodeJS Design Patterns</a>
                </div>
                <p class="mt-2 grow line-clamp-3">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                </p>
                <div class="mt-4 flex items-center justify-between">
                  <a href="#" class="flex items-center space-x-2 text-xs hover:text-slate-800 dark:hover:text-navy-100">
                    <div class="avatar size-6">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-16.jpg') }}" alt="avatar">
                    </div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-7.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
                  <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">313 Pattern and Color ideas</a>
                </div>
                <p class="mt-2 grow line-clamp-3">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                </p>
                <div class="mt-4 flex items-center justify-between">
                  <a href="#" class="flex items-center space-x-2 text-xs hover:text-slate-800 dark:hover:text-navy-100">
                    <div class="avatar size-6">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-7.jpg') }}" alt="avatar">
                    </div>
            ...
            <div class="flex flex-col">
              <img class="h-44 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/object/object-6.jpg') }}" alt="image">
              <div class="card -mt-8 grow rounded-2xl p-4">
                <div>
                  <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">25 Surprising Facts About Chair</a>
                </div>
                <p class="mt-2 grow line-clamp-3">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                </p>
                <div class="mt-4 flex items-center justify-between">
                  <a href="#" class="flex items-center space-x-2 text-xs hover:text-slate-800 dark:hover:text-navy-100">
                    <div class="avatar size-6">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-1.jpg') }}" alt="avatar">
                    </div>
                    <span class="line-clamp-1">Konnor Guzman </span>
                  </a>
                  <p class="flex shrink-0 items-center space-x-1.5 text-slate-400 dark:text-navy-300">
