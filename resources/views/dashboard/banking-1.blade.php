          ...
          <div class="col-span-12 lg:order-last lg:col-span-4">
            <div class="swiper h-40 w-64" x-init="$nextTick(()=>$el._x_swiper = new Swiper($el,{effect: 'cards'}))">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative flex h-full flex-col overflow-hidden rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-5">
                  <div class="grow">
                    <img class="h-3" src="{{ asset('assets/images/payments/cc-visa-white.svg') }}" alt="image">
                  </div>
                  <div class="text-white">
                ...
                <div class="swiper-slide relative flex h-full flex-col overflow-hidden rounded-xl bg-gradient-to-br from-info to-info-focus p-5">
                  <div class="grow">
                    <img class="h-3" src="{{ asset('assets/images/payments/cc-visa-white.svg') }}" alt="image">
                  </div>
                  <div class="text-white">
