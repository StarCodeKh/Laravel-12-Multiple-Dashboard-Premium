          ...
          <div class="card col-span-12 pb-4">
            ...
            <div class="mt-3 grid grid-cols-12">
              ...
              <div class="ax-transparent-gridline col-span-12 px-2 sm:col-span-6 lg:col-span-8">
                <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.analyticsPagesViews); $el._x_chart.render() });"></div>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-3.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-17.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-19.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-2.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-1.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-9.jpg') }}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent">
                      ...
                      <td class="min-w-[20rem] px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-12">
                            <img class="rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-14.jpg') }}" alt="avatar">
                          </div>
