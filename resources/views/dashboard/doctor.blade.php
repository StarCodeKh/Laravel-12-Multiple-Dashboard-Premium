          ...
          <div class="col-span-12 lg:col-span-8 xl:col-span-9">
            <div class="card col-span-12 mt-12 bg-gradient-to-r from-blue-500 to-blue-600 p-5 sm:col-span-8 sm:mt-0 sm:flex-row">
              <div class="flex justify-center sm:order-last">
                <img class="-mt-16 h-40 sm:mt-0" src="{{ asset('assets/images/illustrations/doctor.svg') }}" alt="image">
              </div>
              ...
              <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5">
                <div class="card space-y-4 p-5">
                  <div class="flex items-center space-x-3">
                    <div class="avatar">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-19.jpg') }}" alt="image">
                    </div>
                    <div>
                ...
                <div class="card space-y-4 p-5">
                  <div class="flex items-center space-x-3">
                    <div class="avatar">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-18.jpg') }}" alt="image">
                    </div>
                    <div>
                      <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                        Alfredo Elliott
                ...
                <div class="card space-y-4 p-5">
                  <div class="flex items-center space-x-3">
                    <div class="avatar">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="image">
                    </div>
                    <div>
                      <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                        Derrick Simmons
                  ...
                  <table class="is-hoverable w-full text-left">
                    ...
                    <tbody>
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <svg xmlns="http://www.w3.org/2000/svg" class="ml-4 size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                      ...
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                              <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-14.jpg') }}" alt="avatar">
                            </div>
                      ...
                      <tr class="border-y border-transparent">
                        <td class="whitespace-nowrap rounded-bl-lg px-4 py-3 sm:px-5">
                          <div class="flex items-center space-x-4">
                            ...
                            <span class="font-medium text-slate-700 dark:text-navy-100">StarCodeKh
                            </span>
                          </div>
                        </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                ...
                <div class="space-y-4">
                  <div class="flex justify-between">
                    <div class="avatar size-16">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-20.jpg') }}" alt="image">
                    </div>
                    <div>
                      <p>Today</p>
                      <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
