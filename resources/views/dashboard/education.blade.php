        ...
        <div class="flex">
          <div class="swiper mx-0 mt-4 px-[var(--margin-x)] transition-all duration-[.25s]" x-init="$nextTick(()=>new Swiper($el,{  slidesPerView: 'auto', spaceBetween: 18}))">
            <div class="swiper-wrapper">
              ...
              <div class="card swiper-slide flex w-72 shrink-0 justify-between rounded-xl border-l-4 border-secondary p-4">
                <div>
                  <p class="font-medium tracking-wide text-slate-700 line-clamp-2 dark:text-navy-100">
              ...
              <div class="card swiper-slide flex w-72 shrink-0 justify-between rounded-xl border-l-4 border-warning p-4">
                <div>
                  <p class="font-medium tracking-wide text-slate-700 line-clamp-2 dark:text-navy-100">
                    Fundamentals of digital marketing
                  </p>
                  <a href="#" class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">StarCodeKh</a>
                </div>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
          ...
          <div class="col-span-12 flex flex-col sm:col-span-6 lg:col-span-4">
            <div class="m-auto px-5">
              <img class="w-full max-w-xs" src="{{ asset('assets/images/illustrations/awards-man.svg') }}" alt="image">
            </div>
            <div class="mt-4 space-y-4 sm:mt-5 lg:mt-6">
              <div class="card p-4">
                <div class="flex items-center space-x-3">
                  <div>
                    <img class="size-10" src="{{ asset('assets/images/awards/award-31.svg') }}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Advanced Level
              ...
              <div class="card p-4">
                <div class="flex items-center space-x-3">
                  <div>
                    <img class="size-10" src="{{ asset('assets/images/awards/award-27.svg') }}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Boss Level
              ...
              <div class="card p-4">
                <div class="flex items-center space-x-3">
                  <div>
                    <img class="size-10" src="{{ asset('assets/images/awards/award-5.svg') }}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Expert Level
            ...
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-x-5 lg:grid-cols-1">
              <div class="card p-2.5">
                <div class="flex justify-between space-x-2">
                  ...
                  <img class="size-24 rounded-lg object-cover" src="{{ asset('assets/images/others/testing-sm.jpg') }}" alt="image">
                </div>
              </div>
              <div class="card p-2.5">
                <div class="flex justify-between space-x-2">
                  ...
                  <img class="size-24 rounded-lg object-cover" src="{{ asset('assets/images/illustrations/store-ui.svg') }}" alt="image">
                </div>
              </div>
              <div class="card p-2.5">
                <div class="flex justify-between space-x-2">
                  ...
                  <img class="size-24 rounded-lg object-cover" src="{{ asset('assets/images/others/sales-presentation-sm.jpg') }}" alt="image">
                </div>
              </div>
              <div class="card p-2.5">
                <div class="flex justify-between space-x-2">
                  ...
                  <img class="size-24 rounded-lg object-cover" src="{{ asset('assets/images/others/design-sm.jpg') }}" alt="image">
                </div>
              </div>
            </div>
          </div>
