        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
          <div class="card shadow-none">
            ...
            <div class="ax-transparent-gridline ax-rounded-b-lg">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.clientsGrowth); $el._x_chart.render() });"></div>
            </div>
          </div>
          <div class="card shadow-none">
            <div class="mt-2 flex h-8 items-center justify-between px-4">
            ...
            <div class="ax-transparent-gridline ax-rounded-b-lg">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.salesGrowth); $el._x_chart.render() });"></div>
            </div>
          </div>
