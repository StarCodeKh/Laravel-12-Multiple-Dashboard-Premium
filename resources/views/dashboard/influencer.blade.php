                ...
                <tbody>
                  <tr>
                    <td class="whitespace-nowrap pt-4">
                      <div class="flex items-center space-x-3">
                        <div class="avatar size-9">
                          <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" alt="avatar">
                        </div>
                    ...
                    <td class="whitespace-nowrap px-2 pt-4">
                      <a href="#" class="font-inter tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@konnor721
                      </a>
                    </td>
                    <td class="whitespace-nowrap pt-4">
                  ...
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-2 pt-4">
                      <a href="#" class="font-inter tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@Alfredoe
                      </a>
                    </td>
                    <td class="whitespace-nowrap pt-4">
                      <p class="text-right font-medium text-slate-700 dark:text-navy-100">
                  ...
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-2 pt-4">
                      <a href="#" class="font-inter tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@Henry2001
                      </a>
                    </td>
                    <td class="whitespace-nowrap pt-4">
                      <p class="text-right font-medium text-slate-700 dark:text-navy-100">
                  ...
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-2 pt-4">
                      <a href="#" class="font-inter tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@Katrinlady
                      </a>
                    </td>
                    <td class="whitespace-nowrap pt-4">
                      <p class="text-right font-medium text-slate-700 dark:text-navy-100">
                  ...
                  <tr>
                    <td class="whitespace-nowrap pt-4">
                      <div class="flex items-center space-x-3">
                        <div class="avatar size-9">
                          <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-5.jpg') }}" alt="avatar">
                        </div>
                        <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          StarCode Kh
                        </h3>
                    ...
                    <td class="whitespace-nowrap px-2 pt-4">
                      <a href="#" class="font-inter tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@Lanc11
                      </a>
                    </td>
                    <td class="whitespace-nowrap pt-4">
                      <p class="text-right font-medium text-slate-700 dark:text-navy-100">
          ...
          <div class="flex flex-col rounded-xl bg-info/10 py-5 dark:bg-navy-800 lg:flex-row">
            ...
            <div class="scrollbar-sm mt-5 flex space-x-4 overflow-x-auto px-4 sm:px-5 lg:mt-0 lg:pl-0">
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/instagram-round.svg') }}" alt="flag">
                ...
                <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                  ...
                  <a href="#" class="mt-1 font-inter text-xs+ tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@theapp721
                  </a>
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/facebook-round.svg') }}" alt="flag">
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/tik_tok-round.svg') }}" alt="flag">

                <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                  <p class="mt-3 text-base font-medium text-slate-700 dark:text-navy-100">
                    Tik Tok
                  </p>
                  <a href="#" class="mt-1 font-inter text-xs+ tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@theapptik
                  </a>
                  <div class="mt-6 flex justify-center space-x-1 font-inter">
                    <p class="text-4xl font-medium text-slate-700 dark:text-navy-100">
                      +1
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/twitter-round.svg') }}" alt="flag">

                <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                  <p class="mt-3 text-base font-medium text-slate-700 dark:text-navy-100">
                    Twitter
                  </p>
                  <a href="#" class="mt-1 font-inter text-xs+ tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@theapporg
                  </a>
                  <div class="mt-6 flex justify-center space-x-1 font-inter">
                    <p class="text-4xl font-medium text-slate-700 dark:text-navy-100">
                      +1
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/pinterest-round.svg') }}" alt="flag">
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/discord-round.svg') }}" alt="flag">

                <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                  <p class="mt-3 text-base font-medium text-slate-700 dark:text-navy-100">
                    Discord
                  </p>
                  <a href="#" class="mt-1 font-inter text-xs+ tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@theapp2
                  </a>
                  <div class="mt-6 flex justify-center space-x-1 font-inter">
                    <p class="text-4xl font-medium text-slate-700 dark:text-navy-100">
                      +1
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/youtube-round.svg') }}" alt="flag">

                <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                  <p class="mt-3 text-base font-medium text-slate-700 dark:text-navy-100">
                    Youtube
                  </p>
                  <a href="#" class="mt-1 font-inter text-xs+ tracking-wide text-slate-400 hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@theapp
                  </a>
                  <div class="mt-6 flex justify-center space-x-1 font-inter">
                    <p class="text-4xl font-medium text-slate-700 dark:text-navy-100">
                      +2
              ...
              <div class="flex w-36 shrink-0 flex-col items-center">
                <img class="z-10 size-10" src="{{ asset('assets/images/logos/tumblr-round.svg') }}" alt="flag">
