            ...
            <div class="mt-5 grid grid-cols-1 gap-4 px-4 sm:grid-cols-3 sm:px-5">
              <div class="relative flex flex-col overflow-hidden rounded-lg bg-gradient-to-br from-info to-info-focus p-3.5">
                ...
                <div class="flex items-end justify-between space-x-2">
                  ...
                  <a href="#" class="border-b border-dotted border-current pb-0.5 text-xs font-medium text-sky-100 outline-none transition-colors duration-300 line-clamp-1 hover:text-white focus:text-white">Get Report
                  </a>
                </div>
                ...
                <tbody>
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="size-12">
                          <img class="h-full w-full rounded-lg" src="{{ asset('assets/images/travel/travel-12.jpg') }}" alt="image">
                        </div>
                        <div>
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="size-12">
                          <img class="h-full w-full rounded-lg" src="{{ asset('assets/images/travel/travel-11.jpg') }}" alt="image">
                        </div>
                        <div>
                          <p class="font-medium text-slate-600 dark:text-navy-100">
                            Tahiti
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="size-12">
                          <img class="h-full w-full rounded-lg" src="{{ asset('assets/images/travel/travel-4.jpg') }}" alt="image">
                        </div>
                        <div>
                          <p class="font-medium text-slate-600 dark:text-navy-100">
                            Argentine Patagonia
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="size-12">
                          <img class="h-full w-full rounded-lg" src="{{ asset('assets/images/travel/travel-6.jpg') }}" alt="image">
                        </div>
                        <div>
                          <p class="font-medium text-slate-600 dark:text-navy-100">
                            Amalfi Coast
                  ...
                  <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                      <div class="flex items-center space-x-4">
                        <div class="size-12">
                          <img class="h-full w-full rounded-lg" src="{{ asset('assets/images/travel/travel-5.jpg') }}" alt="image">
                        </div>
                        <div>
                          <p class="font-medium text-slate-600 dark:text-navy-100">
                            Great Barrier Reef
            ...
            <div class="flex flex-col justify-between space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5">
              ...
              <ol class="pagination">
                <li class="rounded-l-full bg-slate-150 dark:bg-navy-500">
                  <a href="#" class="flex size-8 items-center justify-center rounded-full text-slate-500 transition-colors hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300/80 dark:text-navy-200 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
          ...
          <div class="col-span-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:col-span-4 lg:grid-cols-1 lg:gap-6 xl:col-span-3">
            ...
            <div class="card">
              ...
              <div class="ax-transparent-gridline">
                <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.travelExpense); $el._x_chart.render() });"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="rounded-l-lg bg-slate-150 pt-4 pb-1 dark:bg-navy-800">
            ...
            <div class="scrollbar-sm mt-4 flex space-x-4 overflow-x-auto px-4 pb-4 sm:px-5">
              <div class="flex w-72 shrink-0 flex-col">
                <img class="h-48 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/travel/hotel-3.jpg') }}" alt="image">
                ...
                <div class="card mx-2 -mt-8 grow rounded-2xl p-3.5">
                  ...
                  <div class="mt-2">
                    <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Emerald Bay Inn.</a>
                  </div>
              ...
              <div class="flex w-72 shrink-0 flex-col">
                <img class="h-48 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/travel/hotel-1.jpg') }}" alt="image">
                ...
                <div class="card mx-2 -mt-8 grow rounded-2xl p-3.5">
                  ...
                  <div class="mt-2">
                    <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Crowne Plaza.</a>
                  </div>
                  <div class="flex items-end justify-between">
                    <p class="mt-2">
              ...
              <div class="flex w-72 shrink-0 flex-col">
                <img class="h-48 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/travel/hotel-5.jpg') }}" alt="image">
                ...
                <div class="card mx-2 -mt-8 grow rounded-2xl p-3.5">
                  ...
                  <div class="mt-2">
                    <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Sunset Lodge.</a>
                  </div>
                  <div class="flex items-end justify-between">
                    <p class="mt-2">
                      <span class="text-base font-medium text-slate-700 dark:text-navy-100">$100</span>
              ...
              <div class="flex w-72 shrink-0 flex-col">
                <img class="h-48 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/travel/hotel-7.jpg') }}" alt="image">
                ...
                <div class="card mx-2 -mt-8 grow rounded-2xl p-3.5">
                  ...
                  <div class="mt-2">
                    <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Hotel Elite.</a>
                  </div>
                  <div class="flex items-end justify-between">
                    <p class="mt-2">
              ...
              <div class="flex w-72 shrink-0 flex-col">
                <img class="h-48 w-full rounded-2xl object-cover object-center" src="{{ asset('assets/images/travel/hotel-8.jpg') }}" alt="image">
                ...
                <div class="card mx-2 -mt-8 grow rounded-2xl p-3.5">
                  ...
                  <div class="mt-2">
                    <a href="#" class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Hotel Bliss.</a>
                  </div>
                  <div class="flex items-end justify-between">
                    <p class="mt-2">
