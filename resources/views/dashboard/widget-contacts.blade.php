        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
          <div class="space-y-4 sm:space-y-5 lg:space-y-6">
            <div class="card items-center p-4 sm:p-5 lg:p-7">
              ...
              <div class="mt-6 flex space-x-6">
                <button class="btn size-9 rounded-full bg-success p-0 font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90">
                  <i class="fa-solid fa-phone"></i>
                </button>
                <button class="btn size-9 rounded-full bg-error p-0 font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90">
            ...
            <div class="card items-center p-4 sm:p-5 lg:p-7">
              ...
              <div class="mt-6 grid grid-cols-3 gap-4">
                <button class="btn size-9 rounded-full p-0 text-slate-700 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-100 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <label class="relative flex">
              <input class="form-input peer h-9 w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="112 Contacts" type="text">
            ...
            <div class="mt-4 space-y-3.5" x-data="{expandedItem:'item-1'}">
              ...
              <div x-data="accordionItem('item-2')">
                <div class="flex items-center justify-between">
                  <div class="flex space-x-4">
                    <div class="avatar size-10">
                      <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="avatar">
                    </div>
                    <div>
                      <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                        Alfredo Elliott
            ...
            <div class="card px-4 pb-4 sm:px-5">
              ...
              <div class="mt-4 space-y-3.5">
                <label class="flex items-center justify-between space-x-2">
                  ...
                  <input checked="" class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-transparent before:rounded-full before:bg-slate-300 checked:!border-success checked:before:!bg-success dark:border-navy-400 dark:before:bg-navy-300" type="checkbox">
                </label>
                <label class="flex items-center justify-between space-x-2">
                ...
                <label class="flex items-center justify-between space-x-2">
                  ...
                  <input checked="" class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-transparent before:rounded-full before:bg-slate-300 checked:border-secondary checked:before:bg-secondary dark:border-navy-400 dark:before:bg-navy-300 dark:checked:border-secondary-light dark:checked:before:bg-secondary-light" type="checkbox">
                </label>
                <label class="flex items-center justify-between space-x-2">
                  <span class="font-medium">Incoming calls </span>
                  <input checked="" class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-transparent before:rounded-full before:bg-slate-300 checked:!border-warning checked:before:!bg-warning dark:border-navy-400 dark:before:bg-navy-300" type="checkbox">
                </label>
              </div>
              <button class="btn mt-6 space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
            ...
            <div class="card p-4 sm:p-5">
              ...
              <div class="mt-6 flex items-center justify-between">
                <div class="space-x-1.5">
                  ...
                  <button class="btn size-8 rounded-full bg-error p-0 font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90">
