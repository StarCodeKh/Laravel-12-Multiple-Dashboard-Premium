    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center space-x-4 py-5 lg:py-6">
          ...
          <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
              <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="#">Dashboards</a>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
          <div class="space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            <div class="card p-3">
              <img class="h-48 rounded-lg object-cover object-center" src="{{ asset('assets/images/object/object-3.jpg') }}" alt="image">
              <div class="mt-3">
            ...
            <div class="card p-4">
              <div class="flex -space-x-px">
                <input class="form-input h-10 w-full rounded-l-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Search here..." type="text">
                <button class="btn z-2 size-10 shrink-0 rounded-l-none bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                  <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <div class="space-y-4 sm:space-y-5 lg:space-y-6">
            <div class="card p-3">
              <div class="grid grid-cols-3 gap-3">
                <img src="{{ asset('assets/images/object/object-3.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
                <img src="{{ asset('assets/images/object/object-4.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
                <img src="{{ asset('assets/images/object/object-5.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
                <img src="{{ asset('assets/images/object/object-9.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
                <img src="{{ asset('assets/images/object/object-8.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
                <img src="{{ asset('assets/images/object/object-7.jpg') }}" class="rounded-lg object-cover object-center" alt="image">
              </div>
            </div>
            <div class="card flex-row space-x-4 p-3">
              <div class="w-12 shrink-0">
                <img class="w-full" src="{{ asset('assets/images/illustrations/creativedesign-char.svg') }}" alt="image">
              </div>
              <div>
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="relative flex flex-col items-center justify-center rounded-lg border border-slate-200 p-4 dark:border-navy-500">
                  <div class="absolute top-0 right-0 mx-2 my-1">
                    <button class="text-slate-400 transition-colors hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">
                      <i class="fa-solid fa-xmark"></i>
                    </button>
                  </div>
                  <div class="avatar size-10">
                    <img class="mask is-hexagon" src="{{ asset('assets/images/avatar/avatar-10.jpg') }}" alt="avatar">
                  </div>
                  <p class="mt-1.5 font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                    John D.
                  </p>
                  <button class="btn mt-3 h-6 rounded-full bg-slate-150 px-3 text-xs font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    Follow
                  </button>
                </div>
                <div class="relative flex flex-col items-center justify-center rounded-lg border border-slate-200 p-4 dark:border-navy-500">
                  ...
                  <div class="avatar size-10">
                    <img class="mask is-hexagon" src="{{ asset('assets/images/avatar/avatar-20.jpg') }}" alt="avatar">
                  </div>
                  <p class="mt-1.5 font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                    Travis F.
                  </p>
                ...
                <div class="relative flex flex-col items-center justify-center rounded-lg border border-slate-200 p-4 dark:border-navy-500">
                  ...
                  <div class="avatar size-10">
                    <img class="mask is-hexagon" src="{{ asset('assets/images/avatar/avatar-19.jpg') }}" alt="avatar">
                  </div>
                  <p class="mt-1.5 font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                    Alfredo E.
                  </p>
                ...
                <div class="relative flex flex-col items-center justify-center rounded-lg border border-slate-200 p-4 dark:border-navy-500">
                  ...
                  <div class="avatar size-10">
                    <img class="mask is-hexagon" src="{{ asset('assets/images/avatar/avatar-18.jpg') }}" alt="avatar">
                  </div>
                  <p class="mt-1.5 font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                    Raul B.
                  </p>
            ...
            <div class="card flex-row items-center space-x-4 p-4">
              <div class="flex flex-wrap -space-x-2">
                <div class="avatar size-10 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="avatar">
                </div>
                <div class="avatar size-10 hover:z-10">
              ...
              <div>
                ...
                <div class="flex text-xs+">
                  <a href="#" class="text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">Konnor</a>
                  <div class="mx-2 my-1 w-px bg-slate-200 dark:bg-navy-500"></div>
                  <a href="#" class="text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">John</a>
                </div>
              </div>
            </div>
          </div>
          <div class="space-y-4 sm:space-y-5 lg:space-y-6">
            <div class="card p-4 sm:p-5">
              ...
              <div class="mt-4 grid grid-cols-4 gap-3">
                <div class="text-center">
                  <div class="avatar size-10">
                    <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-2.jpg') }}" alt="avatar">
                  </div>
                ...
                <div class="text-center">
                  <div class="avatar size-10">
                    <img class="rounded-full" src="{{ asset('assets/images/avatar/avatar-17.jpg') }}" alt="avatar">
                  </div>
                  <p class="mt-1.5 text-xs+ font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                    Travis
                  </p>
            ...
            <div class="card space-y-4 p-4 sm:p-5">
              ...
              <div class="flex items-center space-x-4">
                <div class="size-5 rounded border-2 border-secondary bg-transparent dark:border-secondary-light"></div>
                <p>Secondary Color</p>
              </div>
              <div class="flex items-center space-x-4">
            ...
            <div class="card px-4 pb-5 sm:px-5">
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                  <div class="mask is-squircle flex size-10 items-center justify-center bg-primary/10 dark:bg-accent-light/10">
