          ...
          <div class="card group col-span-12 lg:col-span-7">
            <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
              ...
              <div class="hidden justify-between space-x-4 text-xs+ sm:flex" x-data="{activeTab:'tabAll'}">
                ...
                <button @click="activeTab = 'tabAll'" class="font-medium tracking-wide" :class="activeTab === 'tabAll' && 'text-primary dark:text-accent-light' ">
                  All time
                </button>
              </div>
            </div>
            <div class="ax-transparent-gridline pr-2">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.serverTraffic); $el._x_chart.render() });"></div>
            </div>
          </div>
          <div class="order-first col-span-12 grid grid-cols-2 gap-4 sm:order-none sm:gap-5 lg:col-span-5 lg:gap-6">
            <div class="card row-span-2 justify-between py-5 px-2 text-center">
              ...
              <div class="ax-transparent-gridline pr-1">
                <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.cpuUsage); $el._x_chart.render() });"></div>
              </div>
            ...
            <div class="card justify-center p-4">
              <div class="flex items-center space-x-3">
                <div>
                  <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.storageUsage); $el._x_chart.render() });"></div>
                </div>
            ...
            <div class="card justify-center p-4">
              <div class="flex items-center space-x-3">
                <div>
                  <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.memoryUsage); $el._x_chart.render() });"></div>
                </div>
                <div class="text-xs+ font-medium text-slate-700 dark:text-navy-100">
                  Memory Usage
                </div>
          ...
          <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{ asset('assets/images/flags/usa-round.svg') }}" alt="flag">
            ...
            <div class="card space-y-6 p-4 sm:px-5">
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{ asset('assets/images/flags/united-kingdom-round.svg') }}" alt="flag">
                    <p class="font-medium text-slate-700 dark:text-navy-100">
                      UK
                    </p>
                  </div>
            ...
            <div class="card space-y-6 p-4 sm:px-5">
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{ asset('assets/images/flags/switzerland-round.svg') }}" alt="flag">
                    <p class="font-medium text-slate-700 dark:text-navy-100">
                      Switzerland
                    </p>
                  </div>
